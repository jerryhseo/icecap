...
public class DataEntryUtil {
	 ...
	 */
	public static List<DataEntry> filterFindByGroupId(long groupId) {
	 ...
	 */
	public static List<DataEntry> filterFindByGroupId(
		long groupId, int start, int end) {
	 ...
	 * @throws NoSuchDataEntryException if a data entry with the primary key could not be found
	 */
	public static DataEntry[] filterFindByGroupId_PrevAndNext(
			long dataEntryId, long groupId,
			OrderByComparator<DataEntry> orderByComparator)
		throws com.osp.icecap.exception.NoSuchDataEntryException {
	 ...
	 * @return the matching data entries
	 */
	public static List<DataEntry> findByDataTypeId(long dataTypeId) {
	 ...
	 * @return the range of matching data entries
	 */
	public static List<DataEntry> findByDataTypeId(
	 ...
	 * @throws NoSuchDataEntryException if a matching data entry could not be found
	 */
	public static DataEntry findByDataTypeId_First(
	 ...
	 * @return the first matching data entry, or <code>null</code> if a matching data entry could not be found
	 */
	public static DataEntry fetchByDataTypeId_First(
		long dataTypeId, OrderByComparator<DataEntry> orderByComparator) {
	 ...
	 * @throws NoSuchDataEntryException if a matching data entry could not be found
	 */
	public static DataEntry findByDataTypeId_Last(
			long dataTypeId, OrderByComparator<DataEntry> orderByComparator)
		throws com.osp.icecap.exception.NoSuchDataEntryException {
	 ...
	 * @return the last matching data entry, or <code>null</code> if a matching data entry could not be found
	 */
	public static DataEntry fetchByDataTypeId_Last(
		long dataTypeId, OrderByComparator<DataEntry> orderByComparator) {
	 ...
	 * @throws NoSuchDataEntryException if a data entry with the primary key could not be found
	 */
	public static DataEntry[] findByDataTypeId_PrevAndNext(
			long dataEntryId, long dataTypeId,
			OrderByComparator<DataEntry> orderByComparator)
		throws com.osp.icecap.exception.NoSuchDataEntryException {

		return getPersistence().findByDataTypeId_PrevAndNext(
			dataEntryId, dataTypeId, orderByComparator);
	}
