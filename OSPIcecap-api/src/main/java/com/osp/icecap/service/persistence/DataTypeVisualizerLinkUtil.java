...
public class DataTypeVisualizerLinkUtil {
	...
	public static List<DataTypeVisualizerLink> findByVisualizerName(
		...
		return getPersistence().findByVisualizerName(
			visualizerName, start, end, orderByComparator, useFinderCache);
	}
	...
	public static DataTypeVisualizerLink fetchByVisualizerNameVersion(
		...
		return getPersistence().fetchByVisualizerNameVersion(
			visualizerName, visualizerVersion, useFinderCache);
	}
	...
	public static List<DataTypeVisualizerLink> findByEditable(
		...
		return getPersistence().findByEditable(
			editable, start, end, orderByComparator, useFinderCache);
	}
	 ...
	 * @return the matching data type visualizer links
	 */
	public static List<DataTypeVisualizerLink> findByDataTypeIdEditable(
		long dataTypeId, boolean editable) {

		return getPersistence().findByDataTypeIdEditable(dataTypeId, editable);
	}
	...
	public static List<DataTypeVisualizerLink> findByDataTypeIdEditable(
		...
		return getPersistence().findByDataTypeIdEditable(
			dataTypeId, editable, start, end);
	}
	 ...
	 * @throws NoSuchDataTypeVisualizerLinkException if a matching data type visualizer link could not be found
	 */
	public static DataTypeVisualizerLink findByDataTypeIdEditable_First(
			long dataTypeId, boolean editable,
			OrderByComparator<DataTypeVisualizerLink> orderByComparator)
		throws com.osp.icecap.exception.NoSuchDataTypeVisualizerLinkException {

		return getPersistence().findByDataTypeIdEditable_First(
	 ...
	 * @return the first matching data type visualizer link, or <code>null</code> if a matching data type visualizer link could not be found
	 */
	public static DataTypeVisualizerLink fetchByDataTypeIdEditable_First(
		long dataTypeId, boolean editable,
		OrderByComparator<DataTypeVisualizerLink> orderByComparator) {

		return getPersistence().fetchByDataTypeIdEditable_First(
			dataTypeId, editable, orderByComparator);
	}
	 ...
	 * @throws NoSuchDataTypeVisualizerLinkException if a matching data type visualizer link could not be found
	 */
	public static DataTypeVisualizerLink findByDataTypeIdEditable_Last(
			long dataTypeId, boolean editable,
			OrderByComparator<DataTypeVisualizerLink> orderByComparator)
		throws com.osp.icecap.exception.NoSuchDataTypeVisualizerLinkException {

		return getPersistence().findByDataTypeIdEditable_Last(
			dataTypeId, editable, orderByComparator);
	}
	 ...
	 * @return the last matching data type visualizer link, or <code>null</code> if a matching data type visualizer link could not be found
	 */
	public static DataTypeVisualizerLink fetchByDataTypeIdEditable_Last(
		long dataTypeId, boolean editable,
		OrderByComparator<DataTypeVisualizerLink> orderByComparator) {

		return getPersistence().fetchByDataTypeIdEditable_Last(
			dataTypeId, editable, orderByComparator);
	}
	 ...
	 * @throws NoSuchDataTypeVisualizerLinkException if a data type visualizer link with the primary key could not be found
	 */
	public static DataTypeVisualizerLink[] findByDataTypeIdEditable_PrevAndNext(
			long dataTypeVisualizerLinkId, long dataTypeId, boolean editable,
			OrderByComparator<DataTypeVisualizerLink> orderByComparator)
		throws com.osp.icecap.exception.NoSuchDataTypeVisualizerLinkException {

		return getPersistence().findByDataTypeIdEditable_PrevAndNext(
			dataTypeVisualizerLinkId, dataTypeId, editable, orderByComparator);
	}
	 ...
	 * @param editable the editable
	 */
	public static void removeByDataTypeIdEditable(
		long dataTypeId, boolean editable) {

		getPersistence().removeByDataTypeIdEditable(dataTypeId, editable);
	}
	 ...
	 * @return the number of matching data type visualizer links
	 */
	public static int countByDataTypeIdEditable(
		long dataTypeId, boolean editable) {

		return getPersistence().countByDataTypeIdEditable(dataTypeId, editable);
	}
