 ...
 */
@ProviderType
public interface DataCollectionLayoutPersistence
	extends BasePersistence<DataCollectionLayout> {
	...
	public java.util.List<DataCollectionLayout> findAll(
		int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<DataCollectionLayout>
			orderByComparator);
