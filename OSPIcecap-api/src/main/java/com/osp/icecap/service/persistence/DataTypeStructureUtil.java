...
public class DataTypeStructureUtil {
	...
	public static DataTypeStructure remove(long dataTypeId)
		throws com.osp.icecap.exception.NoSuchDataTypeStructureException {
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(
			DataTypeStructurePersistence.class);

		ServiceTracker
			<DataTypeStructurePersistence, DataTypeStructurePersistence>
				serviceTracker =
					new ServiceTracker
						<DataTypeStructurePersistence,
						 DataTypeStructurePersistence>(
							 bundle.getBundleContext(),
							 DataTypeStructurePersistence.class, null);
