...
/**
 * The extended model interface for the DataPack service. Represents a row in the &quot;ICECAP_DataPack&quot; database table, with each column mapped to a property of this class.
 *
 * @author Jerry H. Seo
 * @see DataPackModel
 * @generated
 */
@ImplementationClassName("com.osp.icecap.model.impl.DataPackImpl")
@ProviderType
public interface DataPack extends DataPackModel, PersistedModel {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add methods to <code>com.osp.icecap.model.impl.DataPackImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
