...
public class DataAnalysisLayoutPersistenceImpl
	...
	public List<DataAnalysisLayout> findByDataCollectionId(
		...
		if (list == null) {
			...
			sb.append(_SQL_SELECT_DATAANALYSISLAYOUT_WHERE);
			...
			if (orderByComparator != null) {
				...
				sb.append(DataAnalysisLayoutModelImpl.ORDER_BY_JPQL);
			}
	...
	public DataAnalysisLayout findByDataCollectionId_First(
		...
		throw new NoSuchDataAnalysisLayoutException(sb.toString());
	}
	...
	protected DataAnalysisLayout getByDataCollectionId_PrevAndNext(
		...
		List<DataAnalysisLayout> list = query.list();
	...
	public int countByDataCollectionId(long dataCollectionId) {
		...
		if (count == null) {
			...
			sb.append(_SQL_COUNT_DATAANALYSISLAYOUT_WHERE);
	...
	public void clearCache(Set<Serializable> primaryKeys) {
		...
		for (Serializable primaryKey : primaryKeys) {
			entityCache.removeResult(
				entityCacheEnabled, DataAnalysisLayoutImpl.class, primaryKey);
		}
	}
	...
	public DataAnalysisLayout remove(Serializable primaryKey)
		...
		catch (NoSuchDataAnalysisLayoutException noSuchEntityException) {
	...
	public List<DataAnalysisLayout> findAll(
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				sb.append(_SQL_SELECT_DATAANALYSISLAYOUT);
