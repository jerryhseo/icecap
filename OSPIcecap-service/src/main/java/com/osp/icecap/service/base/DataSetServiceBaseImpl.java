...
import com.osp.icecap.service.DataSetService;
...
/**
 * Provides the base implementation for the data set remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.osp.icecap.service.impl.DataSetServiceImpl}.
 * </p>
 *
 * @author Jerry H. Seo
 * @see com.osp.icecap.service.impl.DataSetServiceImpl
 * @generated
 */
public abstract class DataSetServiceBaseImpl
	extends BaseServiceImpl
	implements DataSetService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DataSetService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.osp.icecap.service.DataSetServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			DataSetService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		dataSetService = (DataSetService)aopProxy;
	}
	...
	@Reference
	protected com.osp.icecap.service.DataSetLocalService dataSetLocalService;
