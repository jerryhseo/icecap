...
public class DataSectionResourcePermissionRegistrar {
	@Activate
    public void activate(BundleContext bundleContext) {
        Dictionary<String, Object> properties = new HashMapDictionary<>();

        properties.put("model.class.name", DataSection.class.getName());

        _serviceRegistration = bundleContext.registerService(
            ModelResourcePermission.class,
            ModelResourcePermissionFactory.create(
            		DataSection.class, DataSection::getPrimaryKey,
                _dataSectionLocalService::getDataSection, _portletResourcePermission,
                (modelResourcePermission, consumer) -> {
                    ...
                    consumer.accept(
                        new WorkflowedModelPermissionLogic<>(
                                ...
                                _groupLocalService, DataSection::getPrimaryKey));
                }),
            properties);
    }
