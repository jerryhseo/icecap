...
public class DataSectionSearchRegistrar {
	@Activate
    protected void activate(BundleContext bundleContext) {

        _serviceRegistration = modelSearchRegistrarHelper.register(
            DataSection.class, bundleContext, modelSearchDefinition -> {
    ...
    protected ModelIndexerWriterContributor<DataSection> modelIndexWriterContributor;
