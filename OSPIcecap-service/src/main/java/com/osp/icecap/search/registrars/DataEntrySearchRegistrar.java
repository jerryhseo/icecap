...
public class DataEntrySearchRegistrar {
	@Activate
    protected void activate(BundleContext bundleContext) {

        _serviceRegistration = modelSearchRegistrarHelper.register(
            DataEntry.class, bundleContext, modelSearchDefinition -> {
    ...
    protected ModelIndexerWriterContributor<DataEntry> modelIndexWriterContributor;
