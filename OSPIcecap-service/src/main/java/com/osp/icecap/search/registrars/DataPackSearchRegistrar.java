...
public class DataPackSearchRegistrar {
	@Activate
    protected void activate(BundleContext bundleContext) {

        _serviceRegistration = modelSearchRegistrarHelper.register(
            DataPack.class, bundleContext, modelSearchDefinition -> {
    ...
    protected ModelIndexerWriterContributor<DataPack> modelIndexWriterContributor;
